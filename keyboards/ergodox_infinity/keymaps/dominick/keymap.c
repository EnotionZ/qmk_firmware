 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  End |  App | LALT | Ctrl |                                       |  '"  |  -_  |   FN |  Alt | Ctrl |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Pscr | Ins  |       | Mute |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space| LGUI |------|       |------|  RGUI  |BKSPC |
 *                                 |      |      | Del  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV), KC_END,     KC_APP, KC_LALT, KC_LCTL,
                                                    KC_PSCR,  KC_INS,
                                                             KC_HOME,
                                               KC_SPC,KC_LGUI,KC_DEL,
        // right hand
             KC_RGHT,     KC_6,   KC_7,  KC_8,    KC_9,   KC_0,    KC_EQL,
             KC_RBRC,     KC_Y,   KC_U,  KC_I,    KC_O,   KC_P,    KC_BSLS,
                          KC_H,   KC_J,  KC_K,    KC_L,   KC_SCLN, KC_ENT,
             MEH_T(KC_NO),KC_N,   KC_M,  KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                               KC_QUOT,  KC_MINS, FN,     KC_RALT, KC_RCTL,
 ...
 * |         |      |  UP  |      |      |      |      |           |      |   Up |   7  |   8  |   9  |   *  |  Home  |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         | LEFT | DOWN | RIGHT|      |      |------|           |------| Down |   4  |   5  |   6  |   +  |  End   |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         |      |      |      |      |      |      |           |      |   &  |   1  |   2  |   3  |   \  |        |
 * `---------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |       |      |      |      |      |                                       |      |    . |   0  |   =  |      |
...
[SYMB] = LAYOUT_ergodox(
       ...
       _______,_______,_______,_______,  PWDAA,   PWD,_______,
       ...
       _______, KC_UP,   KC_7,   KC_8,    KC_9,    KC_ASTR, KC_HOME,
                KC_DOWN, KC_4,   KC_5,    KC_6,    KC_PLUS, KC_END,
