...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
      ...
      KC_LCTL, KC_LALT,          TD_LWRC, KC_SPC,                        KC_BSPC, RAISE,                     KC_RGUI, KC_RALT
  ),
  ...
  [_MAC] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,
      _______, KC_LGUI,          _______, _______,                       _______, _______,                   KC_RALT, KC_RGUI
  ),
  ...
  [_ADJUST] = LAYOUT(
      ...
      _______, _______,          TD_LWRC, KC_SPC,                        _______, RAISE,                     _______, TGMAC
  ),
};
