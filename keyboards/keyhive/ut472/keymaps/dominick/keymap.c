...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------------------------------------------------------------------+
   * | Ctrl| Menu | Alt | Gui |  L2  |   Space   |  L1  | '" | _ |  = | Esc |
   * `-------------------------------------------------------------------------'
   */
...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL, KC_BSPC, KC_LALT, KC_LGUI, LOWER,      KC_SPC,        RAISE,   KC_BSPC, KC_PGDN, KC_PGUP, KC_END
),
...
[_LOWER] = LAYOUT( /* Left */
  ...
  KC_TAB,  _______, _______, KC_ENT,  _______, PWD1P,   _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, _______,
  KC_TRNS, KC_BSPC, KC_DEL,  _______, PWDME,   PWDAA,   _______, KC_MINS, KC_EQL,  KC_UNDS, _______, _______,
  _______, KC_APP,  _______, _______, LOWER,      KC_BSPC,       RAISE,   _______, KC_HOME, KC_END,  KC_INS
),
