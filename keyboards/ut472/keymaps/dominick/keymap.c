...
[_QWERTY] = LAYOUT(
  ...
  KC_LCTL, KC_BSPC, KC_LALT, KC_LGUI, LOWER,      KC_SPC,        RAISE,   KC_BSPC, KC_MINS,  KC_EQL, RGB_TOG
),
...
[_LOWER] = LAYOUT( /* Left */
  ...
  _______, KC_APP, _______, _______, LOWER,     KC_BSPC,       RAISE, _______,   KC_PGDN, KC_PGUP, KC_END
),
