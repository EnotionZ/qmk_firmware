...
LAYOUT(
  ...
  KC_LCTL, KC_APP, KC_LGUI, KC_LALT,  MO(1),      KC_SPC,     MO(2),      KC_QUOT, KC_MINS,  KC_EQL, KC_BSLS
),
...
LAYOUT( /* Left */
  ...
  _______, _______, _______, _______, _______,     KC_BSPC,     _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
