...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [2] = LAYOUT(
        ...
        MO(2),   _______, _______, _______, KC_ENT,  PWD1P,   _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______, KC_BSPC, KC_DEL,  PWDEV,   PWDME,   PWDAA,   _______, _______, _______, _______, _______, _______,                   KC_UP,   _______,
