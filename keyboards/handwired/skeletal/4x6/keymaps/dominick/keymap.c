...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                        KC_MUTE, KC_LGUI, LOWER,   KC_SPC,      KC_BSPC, RAISE,   KC_RALT, _______
  ),
  ...
  [_LOWER] = LAYOUT(
      ...
      _______, KC_BSPC, KC_DEL,  _______, PWDME,   PWDAA,       _______, KC_MINS, KC_EQL,  KC_UNDS, KC_PLUS, _______,
                        _______, KC_LALT, LOWER,   KC_RGUI,     _______, RAISE,   _______, _______
  ),
  ...
  [_RAISE] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,     KC_MPRV, KC_VOLD, KC_VOLU, KC_MPLY, KC_MNXT, _______,
                        _______, _______, LOWER,   _______,     _______, RAISE,   KC_RGUI, _______
  ),
