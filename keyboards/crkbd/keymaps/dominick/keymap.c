...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT,   LOWER, KC_LCTL,     KC_DEL,   RAISE, KC_RGUI \
                                      //`--------------------------'  `--------------------------'
  ),

  [_LT3TAB] = LAYOUT( \
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      _______, _______,   KC_UP, _______, _______, _______,                      KC_MUTE, KC_LBRC, KC_RBRC, _______, _______,   RESET,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT,   LOWER, _______,    _______,   RAISE, KC_RGUI \
                                      //`--------------------------'  `--------------------------'
  )
};
